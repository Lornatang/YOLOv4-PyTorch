...
def strip_optimizer(f="weights/best.pth"):  # from utils.utils import *; strip_optimizer()
    # Strip optimizer from *.pthh files for lighter files (reduced by 1/2 size)
...
def create_backbone(f="weights/best.pth", s="weights/backbone.pth"):  # from utils.utils import *; create_backbone()
